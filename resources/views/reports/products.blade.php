    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('reports.products') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">
                        Product Sales from {{ date('M d, Y', strtotime($startDate)) }} to {{ date('M d, Y', strtotime($endDate)) }}
                    </h3>
                    ...
                    @else
                        <p class="text-gray-500 text-center py-4">No product sales found for this period</p>
                    @endif
                </div>
            </div>
        </div>
